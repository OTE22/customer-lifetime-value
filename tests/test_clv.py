...
class TestDataProcessor:
    ...
    def sample_data(self):
        ...
        return pd.DataFrame({
            ...
            'customer_segment': ['High-CLV', 'Low-CLV', 'High-CLV', 'Low-CLV', 'Growth-Potential'],
...
class TestFeatureEngineering:
    ...
    def test_prepare_feature_matrix(self, sample_data):
        """Test full feature matrix preparation."""
        engineer = FeatureEngineer()
        result = engineer.prepare_feature_matrix(sample_data)
...
class TestMetaAdsIntegration:
    ...
    def predictions_data(self):
        ...
        return pd.DataFrame({
            ...
            'predicted_segment': ['High-CLV', 'Low-CLV', 'Growth-Potential', 'Low-CLV', 'Growth-Potential']
        })
...
class TestIntegration:
    ...
    def test_full_pipeline(self):
        ...
        # Engineer features
        engineer = FeatureEngineer()
        featured_data = engineer.prepare_feature_matrix(processor.processed_data)
