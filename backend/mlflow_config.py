...
class MLflowConfig:
    ...
    def __init__(
        ...
        self.artifact_location = artifact_location or os.getenv("MLFLOW_ARTIFACT_LOCATION", None)
    ...
    def start_run(
        ...
        return mlflow.start_run(run_name=run_name, tags=run_tags, description=description)
    ...
    def get_best_model(
        self, model_name: str, metric: str = "rmse", ascending: bool = True
    ) -> Optional[str]:
        """
...
def init_mlflow(
    ...
    """
    global _mlflow_config
    _mlflow_config = MLflowConfig(tracking_uri=tracking_uri, experiment_name=experiment_name)
    _mlflow_config.setup()
    return _mlflow_config
