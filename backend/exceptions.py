...
class MissingRequiredFieldError(ValidationError):
    ...
    def __init__(self, field: str):
        super().__init__(message=f"Required field '{field}' is missing", field=field)
...
class InsufficientDataError(DataError):
    ...
    def __init__(self, required: int, available: int, operation: str = "operation"):
        super().__init__(
            ...
            details={"required": required, "available": available, "operation": operation},
        )
...
class ModelError(CLVException):
    ...
    def __init__(
        ...
        super().__init__(message, error_code, details={"model_name": model_name, **(details or {})})
...
class FeatureMismatchError(ModelError):
    ...
    def __init__(
        self, expected_features: int, received_features: int, missing: Optional[list] = None
    ):
        super().__init__(
