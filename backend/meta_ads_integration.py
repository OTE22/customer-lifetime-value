...
class MetaAdsIntegration:
    ...
    BUDGET_WEIGHTS = {"High-CLV": 0.50, "Growth-Potential": 0.35, "Low-CLV": 0.15}
    ...
    def generate_audience_segments(
        ...
        for segment_name, audience_df in self.audiences.items():
            ...
            audience_df["lookalike_recommendation"] = self._get_lookalike_recommendation(
                segment_name
            )
    ...
    def _get_targeting_priority(self, segment: str) -> str:
        ...
        priorities = {"High-CLV": "Primary", "Growth-Potential": "Secondary", "Low-CLV": "Tertiary"}
    ...
    def calculate_optimal_cac(
        self, predicted_clv: float, ratio: Optional[float] = None
    ) -> Dict[str, float]:
        """
    ...
    def generate_budget_allocation(
        self, total_budget: float, df: Optional[pd.DataFrame] = None
    ) -> Dict[str, Any]:
        """
        ...
        for segment_name, weight in self.BUDGET_WEIGHTS.items():
            ...
            allocation[segment_name] = {
                ...
                "expected_roas": (
                    round((expected_acquisitions * avg_clv) / segment_budget, 2)
                    if segment_budget > 0
                    else 0
                ),
            }
        ...
        return {
            ...
            "summary": {
                ...
                "blended_roas": (
                    round(total_expected_revenue / total_budget, 2) if total_budget > 0 else 0
                ),
            },
        }
    ...
    def create_lookalike_recommendations(self, df: Optional[pd.DataFrame] = None) -> Dict[str, Any]:
        """
        ...
        recommendations = {
            ...
            "expansion": {
                ...
                "source_size": len(self.audiences.get("High-CLV", []))
                + len(self.audiences.get("Growth-Potential", [])),
                "lookalike_size": "2-3%",
    ...
    def get_campaign_recommendations(self, segment: str) -> Dict[str, Any]:
        """
    ...
    def get_full_strategy(
        ...
        return {
            ...
            "audience_sizes": {
                segment: len(audience) for segment, audience in self.audiences.items()
            },
        }


def create_meta_strategy(predictions_df: pd.DataFrame, total_budget: float) -> Dict[str, Any]:
    """
